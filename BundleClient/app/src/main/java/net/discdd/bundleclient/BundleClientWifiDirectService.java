...
public class BundleClientWifiDirectService extends Service implements WifiDirectStateListener {
    ...
    private static final BundleExchangeCounts ZERO_BUNDLE_EXCHANGE_COUNTS = new BundleExchangeCounts(0, 0,Statuses.FAILED,Statuses.FAILED);
    ...
    private BundleExchangeCounts exchangeWith(WifiP2pDevice device) {
        ...
        return ZERO_BUNDLE_EXCHANGE_COUNTS;
    }
