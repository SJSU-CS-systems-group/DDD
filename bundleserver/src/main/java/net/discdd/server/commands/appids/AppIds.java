...
@CommandLine.Command(name = "appids", description = "List and updatedregistered app ids", mixinStandardHelpOptions = true)
@Component
public class AppIds implements Callable<Integer> {
    ...
    int update(@CommandLine.Parameters(index = "0", description = "The appId to add or update")
    String appId, @CommandLine.Parameters(index = "1", description = "The server address to map to the appId")
    String address) {
    ...
    int delete(@CommandLine.Parameters(index = "0", description = "The appId to delete")
    String appId) {
