...
public class BundleClientToBundleServerTest extends End2EndTest {
    ...
    static void setUp() throws Exception {
        ...
        clientKeyPair = bundleTransmission.getBundleSecurity().getClientSecurity().getClientJavaKeyPair();
        clientCert = bundleTransmission.getBundleSecurity().getClientSecurity().getClientCert();
    }
