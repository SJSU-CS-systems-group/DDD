...
public class DTNApplicationClient {
	...
	/**
	 * Construct client for accessing DTNCommunication server using the existing
	 * channel.
	 */
	...
	public static void main(String[] args) {
		...
		//ConnectionData data = ConnectionData.newBuilder().setAppName("com.example.mysignal").setUrl("localhost:8090")
				.build();
		try {
