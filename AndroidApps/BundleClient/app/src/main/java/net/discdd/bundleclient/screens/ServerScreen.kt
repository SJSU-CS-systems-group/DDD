...
fun ServerScreen(
    ...
    // Confirmation dialog that triggers the actual save ➜ service listener resets keys/session
    ResetKeysWarningDialog(
        show = showResetDialog,
        onConfirm = {
            showResetDialog = false
            serverViewModel.saveDomainPort() // this write triggers BundleClientService’s pref listener to reset keys
        },
...
private fun ResetKeysWarningDialog(
    ...
    androidx.compose.material3.AlertDialog(
        ...
        text = {
            Text(
                "Switching servers will reset your encryption keys and client ID. " +
                        "Existing sessions won’t decrypt on the new server."
            )
        },
        confirmButton = {
