...
public class BundleDeliveryAgent {
    ...
    public BundleDeliveryAgent(Path rootFolder, Consumer<ADU> aduConsumer) throws WindowExceptions.BufferOverflow, RoutingExceptions.ClientMetaDataFileException, IOException,
